...
Documatic will scrape all text files in the specified repository and use OpenAI's text completion and editing models to generate comments for functions and a README document. The generated document and comments will be added to a new branch and a pull request will be created.
